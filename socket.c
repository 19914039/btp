...
#define BUFSIZE 8196
#define MEASURE "SV_PROTO"
#define PORT        8086        /* Port number as an integer - web server default is 80 */
#define IP_ADDRESS "10.12.1.204"    /* IP Address as a string */
#define BUCKET "sv_bucket"
#define ORG "iitr"
#define TOKEN "W_nbq6l4qdlgrsYPbqsB1s9E7mKbA5RX0Nd8Vmyc1A8lNq_HLf6YgnNOvYTf25iDgmZoPcaeWLXCPke20fb2ww=="
